          ...
          <div className="mt-8 lg:mt-0 lg:col-span-4">
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <div className="space-y-4">
                <div className="flex justify-between">
                  <div className="text-base font-medium text-gray-600">Subtotal</div>
                ...
                <div className="flex justify-between">
                  <div className="text-base font-medium text-gray-600">Tax</div>
                  <div className="text-base font-medium text-gray-900">${(getCartTotal() * 0.1).toFixed(2)}</div>
                </div>
